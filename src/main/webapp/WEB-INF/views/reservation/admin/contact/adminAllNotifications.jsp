...
<link rel="stylesheet" type="text/css"
	href="<c:url value='/css/reservation/adminAllnotifications.css'/>">
</head>
<body>
	<jsp:include page="/WEB-INF/views/reservation/admin/functionNav.jsp"></jsp:include>
	<div class="main">
	<div class="title"><img src="https://img.icons8.com/bubbles/50/000000/dog.png"/>全部留言<img style="transform: rotateY(180deg)" src="https://img.icons8.com/bubbles/50/000000/dog.png"/></div>
