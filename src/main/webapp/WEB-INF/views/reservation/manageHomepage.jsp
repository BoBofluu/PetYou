...
<link rel="stylesheet" type="text/css"
	href="<c:url value='/css/reservation/manageHomepage.css'/>">
<link rel="stylesheet" type="text/css"
...
<body>
	...
	<div class="container" style="margin-left: 280px;">
		<h3 class="title">新訂單來了!!</h3>
		<img src="<c:url value='/image/manageHompage/icons8-dog-park-100.png' />" class="left-picture" />
		<img src="<c:url value='/image/manageHompage/icons8-dog-park-100.png' />" class="right-picture"  />
