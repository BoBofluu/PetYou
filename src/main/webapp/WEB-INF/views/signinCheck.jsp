...
<body>
	...
	<div class="form_group">
			<div class="inside_group">
				<h1 style="text-align:center;color:black;margin-left:67px">會員登入<span style="cursor:pointer;opacity:0;" onclick="openNav()" class="fa fa-address-book-o" aria-hidden="true"></span></h1>
				<div style="max-width:350px;margin:auto">  
					<div class="input-icons"> 
						<i class="fa fa-user icon"></i> 
						<input class="input-field" type="text" id="account" name="account" placeholder="請輸入帳號" autocomplete="off"> 
					</div> 
					...
					<div style="width:310px;display:flex;margin:5px auto; ">
						<input type="submit" value="登入" style="border-radius:5px;width:200px;margin-right:10px;" id="HereWeGo">
...
<!-- ============================================================================================================================== -->			
	...
	function openNav() {
		if(myEasterEgg){
			...
			document.getElementById("myEasterEgg").style.width = "0";
			myEasterEgg = true;
		}
	}	 
	 
<!-- ============================================================================================================================== -->			
	document.getElementById("HereWeGo").onclick = function() {
		...
		// 伺服器請求完成
			if (xhr.readyState == 4 && xhr.status == 200) {
				...
				}else if (result.login == "管理員"){
					Swal.fire(
						"真是俏皮的操作阿",
						"把你丟回管理員頁面囉",
						"success"    
					);
					setTimeout('jumpAdmin()', 3000) 
							
				}else if (result.login == "黑名單"){
					Swal.fire(
						"此帳號為黑名單",
						"有任何問題請向客服申訴!",
						"error"    
