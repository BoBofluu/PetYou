...
<body>
	...
	<form method = "post" action = "<c:url value='/insertPersonalShopToSql' />" enctype="multipart/form-data">
		<div class="wrapper clearfix">
			<div class="sidemenu">
				...
				<ul style="list-style: none; line-height: 20px;">
					...
					<li id="onepunch"><i class="fa fa-hand-peace-o" aria-hidden="true">一鍵輸入</i></li>
				</ul>
			</div>
					...
					<div class="form-item fih">
						...
						<div class="form-controler">
							...
							<label style="display:none;">
								<input type="radio" name="type" id="t5" value="哈哈" style="margin:10px;">哈哈<br>
							</label>
						</div>
					</div>
					<hr>
...
<!-- =========================================================================================================================================== -->				
				...
				<div class="form-table">
					...
					<div class="form-item fih" >
						...
						<div class="form-controler">
							<select name="monStart_Time" id="monStart_Time" disabled="disabled" class="theselect">
								<option value="-1" >請選擇</option>
							</select>
							&#126;
							<select name="monEnd_Time" id="monEnd_Time" disabled="disabled" class="theselect">
								<option value="-1" >請選擇</option>
							</select>
							<input type="button"  value="全部套用" style="margin-left:120px;padding-bottom:1px" id="allTheRest"  class="btnAdd" >
...
<!-- 						<div class="form-controler"> -->
<!-- 							<select name="monStart_Time_1" id="monStart_Time_1"  class="theselect"> -->
<!-- 								<option value="-1" >請選擇</option> -->
<!-- 							</select> -->
<!-- 							&#126; -->
<!-- 							<select name="monEnd_Time_1" id="monEnd_Time_1"  class="theselect"> -->
<!-- 								<option value="-1" >請選擇</option> -->
<!-- 							</select> -->
...
<!-- 						<br> -->
<!-- 						<div class="form-controler"> -->
<!-- 							<select name="monStart_Time_2" id="monStart_Time_2" class="theselect"> -->
<!-- 								<option value="-1" >請選擇</option> -->
<!-- 							</select> -->
<!-- 							&#126; -->
<!-- 							<select name="monEnd_Time_2" id="monEnd_Time_2"  class="theselect"> -->
<!-- 								<option value="-1" >請選擇</option> -->
<!-- 							</select> -->
<!-- <!-- 							<input type="button"  value="全部套用" style="margin-left:200px" id="allTheRest"> --> 
...
<!-- 						<br> -->
<!-- 						<div class="form-controler"> -->
<!-- 							<select name="monStart_Time_3" id="monStart_Time_3"  class="theselect"> -->
<!-- 								<option value="-1" >請選擇</option> -->
<!-- 							</select> -->
<!-- 							&#126; -->
<!-- 							<select name="monEnd_Time_3" id="monEnd_Time_3"  class="theselect"> -->
<!-- 								<option value="-1" >請選擇</option> -->
<!-- 							</select> -->
<!-- <!-- 							<input type="button"  value="全部套用" style="margin-left:200px" id="allTheRest"> --> 
<!-- 							<i class="fa fa-minus-circle" aria-hidden="true"></i> -->
...
<!-- 					</div>	display block -->
					...
					<div class="form-item fih">
						...
						<div class="form-controler">
							<select name="tueStart_Time" id="tueStart_Time" disabled="disabled" class="theselect">
								<option value="-1" >請選擇</option>
							</select>
							&#126;
							<select name="tueEnd_Time" id="tueEnd_Time" disabled="disabled" class="theselect">
								<option value="-1" >請選擇</option>
							</select>
						</div>		
					</div>	
					...
					<div class="form-item fih">
						...
						<div class="form-controler" >
							<select name="wedStart_Time" id="wedStart_Time" disabled="disabled" class="theselect">
								<option value="-1" >請選擇</option>
							</select>
							&#126;
							<select name="wedEnd_Time" id="wedEnd_Time" disabled="disabled" class="theselect">
								<option value="-1" >請選擇</option>
							</select>
						</div>		
					</div>	
					...
					<div class="form-item fih">
						...
						<div class="form-controler">
							<select name="thuStart_Time" id="thuStart_Time" disabled="disabled" class="theselect">
								<option value="-1" >請選擇</option>
							</select>
							&#126;
							<select name="thuEnd_Time" id="thuEnd_Time" disabled="disabled" class="theselect">
								<option value="-1" >請選擇</option>
							</select>
						</div>		
					</div>	
					...
					<div class="form-item fih">
						...
						<div class="form-controler">
							<select name="friStart_Time" id="friStart_Time" disabled="disabled" class="theselect">
								<option value="-1" >請選擇</option>
							</select>
							&#126;
							<select name="friEnd_Time" id="friEnd_Time" disabled="disabled" class="theselect">
								<option value="-1" >請選擇</option>
							</select>
						</div>		
					</div>	
					...
					<div class="form-item fih">
						...
						<div class="form-controler">
							<select name="satStart_Time" id="satStart_Time" disabled="disabled" class="theselect">
								<option value="-1" >請選擇</option>
							</select>
							&#126;
							<select name="satEnd_Time" id="satEnd_Time" disabled="disabled" class="theselect">
								<option value="-1" >請選擇</option>
							</select>
						</div>		
					</div>	
					...
					<div class="form-item fih">
						...
						<div class="form-controler">
							<select name="sunStart_Time" id="sunStart_Time" disabled="disabled" class="theselect">
								<option value="-1" >請選擇</option>
							</select>
							&#126;
							<select name="sunEnd_Time" id="sunEnd_Time" disabled="disabled" class="theselect">
								<option value="-1" >請選擇</option>
							</select>
						</div>
					</div>	
				...
				<div id="divphoto">
					...
					<div class="form-item" style="width:400px;margin:15px auto;">
						<div style="position:relative;" >
							<input type="file" style="position:absolute;opacity:0;width:365px;height:191px;cursor: pointer;margin-top: 100px;" id="shopImage" accept=".jpg,.png,.jpeg" name="shopImage"> 
							<img src="${pageContext.request.contextPath}/images/upload.jpg" id="ppimg"  style="width:365px;object-fit: contain;height:365px;"> 
						</div>
					</div>

<!-- 						<input type="button"  value="送出" style="margin-left:200px" id="getTime"> -->
...
<!-- =========================================================================================================== -->		
	$("#onepunch").click(function() {
		...
		$("#township option[value='竹北市']").attr('selected', 'selected');
		$("#lastaddress").val("成功十街91號1樓"); 
		
		$("#address").val("新竹縣竹北市成功十街91號1樓");
		
		$("#propertyPermit").val("特寵業字第D1080031號");
		$("#email").val("Esther@gmail.com");
		$("#sun").val("10:00,10:30,11:00,11:30,12:00,12:30,13:00,13:30,14:00,14:30,15:00,15:30,16:00,16:30,17:00,17:30,18:00,18:30,19:00,19:30,20:00");
		$("#mon").val("10:00,10:30,11:00,11:30,12:00,12:30,13:00,13:30,14:00,14:30,15:00,15:30,16:00,16:30,17:00,17:30,18:00,18:30,19:00,19:30,20:00");
		$("#tue").val("10:00,10:30,11:00,11:30,12:00,12:30,13:00,13:30,14:00,14:30,15:00,15:30,16:00,16:30,17:00,17:30,18:00,18:30,19:00,19:30,20:00");
		$("#wed").val("10:00,10:30,11:00,11:30,12:00,12:30,13:00,13:30,14:00,14:30,15:00,15:30,16:00,16:30,17:00,17:30,18:00,18:30,19:00,19:30,20:00");
		$("#thu").val("10:00,10:30,11:00,11:30,12:00,12:30,13:00,13:30,14:00,14:30,15:00,15:30,16:00,16:30,17:00,17:30,18:00,18:30,19:00,19:30,20:00");
		$("#fri").val("10:00,10:30,11:00,11:30,12:00,12:30,13:00,13:30,14:00,14:30,15:00,15:30,16:00,16:30,17:00,17:30,18:00,18:30,19:00,19:30,20:00");
		$("#sat").val("10:00,10:30,11:00,11:30,12:00,12:30,13:00,13:30,14:00,14:30,15:00,15:30,16:00,16:30,17:00,17:30,18:00,18:30,19:00,19:30,20:00");
		
		$("#sunTilde").val("10:00~20:00");
		$("#monTilde").val("10:00~20:00");
		$("#tueTilde").val("10:00~20:00");
		$("#wedTilde").val("10:00~20:00");
		$("#thuTilde").val("10:00~20:00");
		$("#friTilde").val("10:00~20:00");
		$("#satTilde").val("10:00~20:00");
		var mst = 20;
		var met = 40;
		days.forEach(function(item){
			$("#workOn"+item).prop("checked",true);
		...
		$('[name=beautyTarget]').eq(0).attr("checked",true);
		$('[name=beautyTarget]').eq(1).attr("checked",true);
		
		$('[name=beautyBasicProject]').eq(1).attr("checked",true);
		$('[name=beautyBasicProject]').eq(2).attr("checked",true);
		$('[name=beautyBasicProject]').eq(3).attr("checked",true);
		
		$('[name=beautySpecialProject]').eq(1).attr("checked",true);
		$('[name=beautySpecialProject]').eq(3).attr("checked",true);
		$('[name=beautySpecialProject]').eq(5).attr("checked",true);
		$('[name=beautySpecialProject]').eq(7).attr("checked",true);
...
<!-- =========================================================================================================== -->	
	...
	days.forEach(function(day){ 
		timing($("#"+day+"Start_Time")[0]); 
		timing($("#"+day+"End_Time")[0]); 
	});
	
// 	for(let i = 1;i <= 3; i++){
// 		timing($("#monStart_Time_"+i)[0]);
// 		timing($("#monEnd_Time_"+i)[0]);
// 	}
