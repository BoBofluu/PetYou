						...
						<div class="form-item fih">
							...
							<div class="form-controler">
								...
								<label  style="display:none"> 
			 						<form:radiobutton name="gender" value="" style="margin: 10px"  id="g4" path="gender" checked="checked"/>哈哈<br> 
								</label> 
							</div>
						</div>
						<div class="form-item fih">
							<div style="display:flex">
								...
								<input type="button" class="btnAdd" value="下一頁"
									style="width:80px;margin-left:717px;" id="accountNextPage"/>
							</div>
						</div>	
					</div>
					<div class="fih"></div>
					...
					<div class="form-table">
						...
						<div class="form-item fih">
							...
							<div class="form-controler">
								...
								<label style="display:none"> 
			 						<form:radiobutton name="size" value=""  style="margin: 10px"  id="s4" path="size" checked="checked"/>哈哈<br> 
								</label> 
							</div>
						</div>
						<hr>
						...
						<div class="form-item fih">
							...
							<div class="form-controler">
								...
								<label style="margin-left:50px;"> 
				 				...
				 				<label  style="display:none"> 
									<form:radiobutton name="ligation" value="" style="margin: 10px;"  id="l3" path="ligation" checked="checked"/>哈哈<br> 
				 				</label> 
							</div>
						</div>
						<div class="form-item fih">
							<div style="display:flex">
								<input type="button" class="btnAdd" value="上一頁"
									style="width:80px;float:left" id="infoPreviousPage"/>
															
								
								<input type="button" class="btnAdd" value="下一頁"
									style="width:80px;margin-left:638px;" id="infoNextPage"/>
							</div>
						</div>	
					</div><!-- table -->
					<div class="fih"></div>
					...
					<div class="form-table">
						<div class="form-item" style="width:400px;margin:15px auto;">
							<div style="position:relative;" >
								<form:input type="file" style="position:absolute;opacity:0;width:365px;height:191px;cursor: pointer;margin-top: 100px;" id="petImage" path="petImage" accept=".jpg,.png,.jpeg" /> 
...
<%--          						<img src="${pageContext.request.contextPath}/images/1004.jpg" id="ppimg"  class="salonIcon">		 --%>
<!--        						</div>	 -->
<!-- 						</div> -->
						<div class="form-item fih">
							<div style="display:flex">
