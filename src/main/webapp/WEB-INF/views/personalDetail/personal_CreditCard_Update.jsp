	...
	<form:form method="post" modelAttribute="creditCard" enctype="multipart/form-data">
		...
		<div class="main">
				<div id="divaccount">
					...
					<div class="form-title">修改信用卡資訊</div>
...
<!-- 						<div id="onepunch"><i class="fa fa-hand-peace-o" aria-hidden="true"></i>一鍵輸入</div> -->
						<div style="width:100px;margin-left:720px;">
							<input id="btnAdd" type="submit" value="送出" onclick="return check_element()" class="btnAdd" style="padding-bottom: 1px;">
						</div>
					</div>
					<div class="fih"></div>
				</div>
...
<!-- ==================================================================================================================== -->
	...
	$("#creditCardNumber").val("${creditCard.creditCardNumber}");
	var ed1 = ${fn:split(creditCard.expiryDate,"/")[0]};
	var ed2 = ${fn:split(creditCard.expiryDate,"/")[1]}; 
	$("#expiryDate1").val(ed1);
	$("#expiryDate2").val(ed2);
	if($("#expiryDate1").val().length != 2){
		ed1 = "0" + ed1;
		$("#expiryDate1").val(ed1);
	}
	if($("#expiryDate2").val().length != 2){
		ed2 = "0" + ed2;
		$("#expiryDate2").val(ed2);
	}
	$("#expiryDate").val(ed1 + "/" + ed2);
	$("#reviewCode").val("${creditCard.reviewCode}");
	$("#cardholder").val("${creditCard.cardholder}");
	
	var oldAddress = '${creditCard.billingAddress}';
	...
	$("#billingAddress").val("${creditCard.billingAddress}");
	$("#postalCode").val("${creditCard.postalCode}");
<!-- ==================================================================================================================== -->

<!-- ========================================== ajax檢查卡號 ==========================================================================	 -->
	var prevccnValue = "${creditCard.creditCardNumber}";
