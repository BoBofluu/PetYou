...
<link rel="stylesheet" style = "text/css" href="${pageContext.request.contextPath}/css/sweetalert.css">
...
<body>
	...
	<section class="container">
		<!--       三個地方要完全一樣 -->
		<form:form method='POST' modelAttribute="commodity" class='form-horizontal'
			...
			<fieldset >
				...
				<div class="form-group">
					<label class="control-label col-lg-2 col-lg-2" for='title'>
						商品編號 </label>
					<div class="col-lg-10">
						 <form:input readonly="true" id="commodityID" path="commodityID" type='text'
  							class='form:input-large' value="${commodity.commodityID}"/>  
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						 <form:input id="commodityName" path="commodityName" type='text'
  							class='form:input-large' value="${commodity.commodityName}" />  
					</div>
				</div>
				...
				<div class="form-group">
					<label class='control-label col-lg-2 col-lg-2' for="category">
						類別 </label>
					<div class='col-lg-10'>
						<form:input id="commodityCategory" path="commodityCategory" type='text'
 						class='form:input-large' value="${commodity.commodityCategory}" />  
				...
				<div class="form-group">
					<label class='control-label col-lg-2 col-lg-2' for="commodityTheme">
						主題 </label>
					<div class='col-lg-10'>
						<form:input id="commodityTheme" path="commodityTheme" type='text'
						class='form:input-large' value="${commodity.commodityTheme}" />  
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class='col-lg-10'>
						<form:input id="commodityPrice" path="commodityPrice" type='text'
 						class='form:input-large' value="${commodity.commodityPrice}"/> 
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class='col-lg-10'>
						...
						class='form:input-large' value="${commodity.stockQuantity}"/>  
					</div>
				</div>
				...
				<div class="form-group">
					<label class='control-label col-lg-2 col-lg-2' for="commoditySupplierID">
						供應商 </label>
					<div class='col-lg-10'>
						<form:input id="commoditySupplierID" path="commoditySupplierID" type='text'
						class='form:input-large' value="${commodity.supplierBean.supplierID}"/> 
						 ${commodity.supplierBean.supplierName}
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class='col-lg-10'>
						<form:textarea id="commodityDescriptions" path="commodityDescriptions" 
							class='form:input-large' />${commodityDescriptions}
					</div>
				</div>
