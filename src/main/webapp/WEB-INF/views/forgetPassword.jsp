	...
	<form:form method="post">
		<div class="form_group">
			<div class="inside_group">
				<h1 style="text-align:center;color:black" id="onepunch">忘記密碼</h1>
				<div style="max-width:350px;margin:auto">  
					<div class="input-icons"> 
						<i class="fa fa-user icon"></i> 
						<input class="input-field" type="text" placeholder="請輸入帳號" name="account" id="account"> 
					</div> 
					...
					<div style="border:1px solid gray ;height:91px;color:red;width: 100%;text-align: left;padding-left: 5px;">
						<span>密碼重設信件將寄至您註冊的信箱。</span><br>
						<span>請點選信件中網址重新設定密碼。</span><br>
						<span>若仍收不到信件，請與<a href="<c:url value='/TalkToService'/>">客服</a>聯繫。</span>
					</div>
